...
import type { ContactMessage as _ContactMessage, Employee as _Employee } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addEmployee(arg0: string, arg1: string, arg2: string): Promise<Employee> {
        if (this.processError) {
            try {
    ...
    async getContactMessage(arg0: string): Promise<ContactMessage | null> {
        if (this.processError) {
            try {
    ...
    async updateEmployee(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<Employee> {
        if (this.processError) {
            try {
...
function from_candid_opt_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Employee]): Employee | null {
    return value.length === 0 ? null : value[0];
}
